...
Errores de un proceso dedicated / hub sin los flags del juego pueden ser esperados; no los trates como fallo de la feature salvo que el slice sea eso.
...
- No reescribas sistemas. No evalúes look (eso es un pase visual, no este módulo).
